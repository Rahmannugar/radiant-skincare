  ...
  return (
    <div className="lg:py-48">
      {isNonMobileScreens ? (
        <div>
          <h1
            className="font-semibold leading-6 text-center mb-[-50px]"
            style={roboto}
          >
            About us
          </h1>

          <div className="flex px-10 space-x-12 xl:space-x-20">
            <div className="relative">
              <img
                src={diagonal}
                alt="diagonal"
                className="lg:w-[400px] lg:h-[450px]  xl:w-[534px] xl:h-[600px] max-w-[534px] max-h-[600px]"
              />
              <img
                src={pipette}
                alt="pipette"
                className="absolute lg:top-[65%] lg:left-[50%] lg:w-[220px] lg:h-[180px] xl:w-[310px] xl:h-[240px] max-w-[310px] max-h-[240px]"
              />
            </div>

            <div className="flex flex-col  lg:pt-[170px] xl:pt-[250px]">
              <svg
                width="47"
                height="48"
                viewBox="0 0 47 48"
              ...
              <h1
                className="py-2 xl:py-5 xl:text-2xl lg:text-xl font-bold"
                style={sanchez}
              >
                Natural ingredients
              </h1>
              <p className="leading-6 lg:text-sm" style={roboto}>
              ...
              <button
                ...
                className="flex justify-between items-center px-4  mt-9 py-2 max-w-[150px]"
              >
                <h1 style={roboto} className="text-xs">
                  Shop now
                </h1>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="text-center px-10">
          ...
          <div className="relative flex items-center justify-center">
            <img
              src={diagonal}
              alt="diagonal"
              className="md:h-96 md:w-96 sm:h-[450px] sm:w-[400px]"
            />
            <img
              src={pipette}
              alt="pipette"
              className="absolute top-[90%] left-[80%] sm:top-[90%] sm:left-[65%] transform -translate-x-1/2 -translate-y-1/2 h-2/5 w-2/4 sm:h-40 sm:w-48"
            />
          </div>

          <div className="pt-20 flex flex-col items-center px-5 sm:px-20">
            <svg
              width="47"
              height="48"
              viewBox="0 0 47 48"
          ...
          <div className="pt-10 pb-10 flex flex-col items-center px-5 sm:px-20">
            <svg
              width="48"
              height="48"
              viewBox="0 0 48 48"
